...
if dl_required:
    ...
    (return_val, output) = commands.getstatusoutput("rsync -a andrew@{0}:/home/andrew/go/src/github.com/atw527/image-match/data/frames/{1} data/frames/".format(ENV_MASTER, video_id))
    if return_val != 0:
